...
<body>
  <div class="container">
    ...
    <form method="post" action="/?date=<?= $_GET['date'] ?>&mood=<?= $_GET['mood'] ?>" enctype="multipart/form-data">
      <div class="mb-3">
    ...
    <div>
      ...
      /*echo 'Today is ' . $_GET['date'] . PHP_EOL;
      echo 'I\'m feeling ' . $_GET['mood'] . PHP_EOL;

      echo 'Product name: ' . $_POST['name'] . PHP_EOL;
      echo 'Product price: ' . $_POST['price'] . PHP_EOL;
      echo 'Product audio: ' . $_FILES['audio']['name'] . PHP_EOL;
      ...
      setcookie('my_happy_cookie', 'cokoliv, co mě napadá', time() + 24 * 3600, '/', '', false, true);

      print_r($_COOKIE['my_happy_cookie']);
      setcookie('my_happy_cookie', '', time() - 3600);


      session_start();
      $adminerHash = $_COOKIE['adminer_key'];
      $_SESSION['1e937d2d22ba605b6282580f1fa6c07d'] = 'Franta';
      $_SESSION['d22ba605b6282580f1fa6c07d1e937d2'] = 'Emil';
      $_SESSION['05b6282580f1fa6c07d1e937d2d22ba6'] = 'Vlasta';

      print_r($_SESSION);

      echo 'Current user: ' . $_SESSION[$adminerHash] . PHP_EOL;

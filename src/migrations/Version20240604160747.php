 ...
 */
final class Version20240604160747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tests (id INT NOT NULL, property VARCHAR(255) NOT NULL, number INT NOT NULL, year INT DEFAULT NULL, PRIMARY KEY(id))');

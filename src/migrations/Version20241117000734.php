 ...
 */
final class Version20241117000734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location (id SERIAL NOT NULL, location_text TEXT NOT NULL, position TEXT NOT NULL, is_ending BOOLEAN NOT NULL, options TEXT NOT NULL, PRIMARY KEY(id))');

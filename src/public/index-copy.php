...
<body>
  <div class="container">
    <h1>Smoke Test</h1>
    <p>Check the mailhog web interface at <a href="http://localhost:8025/" target="_blank">http://localhost:8025/</a> to
      see the email.</p>
    <p>Check the adminer web interface at <a href="http://localhost:8080/" target="_blank">http://localhost:8080/</a> to
